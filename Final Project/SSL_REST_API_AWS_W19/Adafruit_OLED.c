...
//*****************************************************************************
/* This function sends a command byte c to the OLED via
 *  SPI.
 */
void writeCommand(unsigned char c)
{
    ...
    // Set CS to low to start sending data -> Pin 59
    ...
    // Set CS to high to end sending data -> Pin 59
    MAP_SPICSDisable(GSPI_BASE);
    GPIOPinWrite(GPIOA0_BASE, 0x10, 0x10);
}
//*****************************************************************************
/* This function sends a data byte c to the OLED via
 *  SPI.
 */
 ...
 *  OLED has been wired to pin 60. If you
