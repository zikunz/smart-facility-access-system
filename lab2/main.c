...
#define APPLICATION_VERSION     "1.1.1.EEC.Winter2022"
#define SERVER_NAME             "auf2lkov3fve3-ats.iot.us-west-2.amazonaws.com.com"
...
#define POSTHEADER "POST /things/CC3200_Things/shadow HTTP/1.1\n\r"

#define HOSTHEADER "Host: auf2lkov3fve3-ats.iot.us-west-2.amazonaws.com\r\n"
#define CHEADER "Connection: Keep-Alive\r\n"
#define CTHEADER "Content-Type: application/json; charset=utf-8\r\n"
#define CLHEADER1 "Content-Length: "
#define CLHEADER2 "\r\n\r\n"

#define DATA1 "{\"state\": {\r\n\"desired\" : {\r\n\"var\" : \"Hello Zikun, message from CC3200 via AWS IoT!\"\r\n}}}\r\n\r\n"
...
void main()
{
    ...
    while (1)
    {
        if (GPIOPinRead(GPIOA1_BASE, 0x20)) // If SW3 is pressed
        {
